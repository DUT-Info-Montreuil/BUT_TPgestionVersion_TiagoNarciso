    ...
    public ArrayList<String> addReplique(String nom){
        ...
        switch (nom) {
            ...
            case "moine":
                ...
                break;
            case "spectre":
            	lines.add("Pour passer au niveau suivant, vous avez deux options : marcher 5 000 pas ou regarder une publicité. Faites votre choix et continuez votre aventure !");
                break;
            case "vieux":
